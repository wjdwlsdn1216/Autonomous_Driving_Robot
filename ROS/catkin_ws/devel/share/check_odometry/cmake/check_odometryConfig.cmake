...
if("TRUE" STREQUAL "TRUE")
  set(check_odometry_SOURCE_PREFIX /home/fetch/catkin_ws/src/check_odometry)
  set(check_odometry_DEVEL_PREFIX /home/fetch/catkin_ws/devel)
  ...
  set(check_odometry_INSTALL_PREFIX /home/fetch/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'check_odometry' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'fetch <fetch@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'check_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fetch/catkin_ws/src/check_odometry/${idir}'.  Ask the maintainer 'fetch <fetch@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${check_odometry_dep}_FOUND)
      find_package(${check_odometry_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${check_odometry_dep} REQUIRED ${depend_list})
  endif()
